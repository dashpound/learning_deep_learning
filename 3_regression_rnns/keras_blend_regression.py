...
def model():
    model = Sequential()
    model.add(layers.Embedding(10000,32, input_length=10000))
    model.add(layers.Conv1D(128,32,activation='relu'))
    model.add(layers.MaxPooling1D(32)) 
